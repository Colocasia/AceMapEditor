...
**使用System.Text.Json + 源生成器**（零反射，AOT友好）

```csharp
// Core/src/Data/UnitDefinition.cs
...
// Core/src/Serialization/DefinitionJsonContext.cs
using System.Text.Json.Serialization;

namespace AceMapEditor.Core.Serialization
{
...
// Core/src/Serialization/DefinitionSerializer.cs
...
namespace AceMapEditor.Core.Serialization
{
    public static class DefinitionSerializer
    {
        ...
        // 反序列化
        public static UnitDefinition DeserializeUnit(string json)
        {
        ...
        // 保存到文件
        public static void SaveUnit(string path, UnitDefinition unit)
        {
            var json = Serialize(unit);
...
仅用于Unity Inspector编辑，数据最终保存为JSON
